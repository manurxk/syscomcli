...
from app.dao.modulos.consultorio.ficha.FichaDao import FichaMedicaDao
...
def generarPDFFichaMedica(id_paciente):
    ...
    try:
        ...
        # Obtener datos de la empresa principal para el encabezado
        ...
        if tipo_pdf == 'basica':
            pdf_buffer = pdf_service.generar_ficha_basica(ficha_completa, config_empresa)
        else:
            pdf_buffer = pdf_service.generar_ficha_completa(ficha_completa, config_empresa)
...
def previewPDFFichaMedica(id_paciente):
    ...
    try:
        ...
        # Obtener datos de la empresa principal
        empresadao = EmpresaDao()
        config_empresa = empresadao.getEmpresaPrincipal()
