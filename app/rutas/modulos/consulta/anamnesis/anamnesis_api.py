...
from app.dao.modulos.consulta.AnamnesisDAO import AnamnesisDao
from app.dao.modulos.ficha.FichaDao import FichaMedicaDao  # ✨ NUEVO
...
def getAnamnesisPorPaciente(id_paciente):
    ...
    try:
        ...
        if anamnesis:
            ...
            return jsonify({'success': False, 'error': 'No se encontró anamnesis activa para este paciente.'}), 404
    except Exception as e:
