    ...
    def getRegistrosDiagnosticos(self):
        ...
        try:
            ...
            return [{
                ...
                'codigo_cie10': d[13],
                'codigo_dsm5': d[14],
                'profesional_nombre': d[15],
                'fecha_registro': d[16].strftime('%d/%m/%Y') if d[16] else None
    ...
    def getDiagnosticosPorConsulta(self, id_consulta):
        ...
        try:
            ...
            return [{
                ...
                'tipo': d[4],
                'gravedad': d[5],
                'fecha': d[6].strftime('%d/%m/%Y') if d[6] else None,
                'descripcion': d[7]
            } for d in diagnosticos]
    ...
    def getDiagnosticosPorPaciente(self, id_paciente):
        ...
        try:
            ...
            return [{
                ...
                'tipo': d[4],
                'gravedad': d[5],
                'fecha_diagnostico': d[6].strftime('%d/%m/%Y') if d[6] else None,
